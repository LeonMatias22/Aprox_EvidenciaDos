...
#Datos de conexión a la base de datos MySQL que luego se utilizan en la
# función save_to_database donde se hace la conexión. Formato JSON
db_config = {
    'user': 'root',
    'password': '420926',
...
def on_message(client, userdata, msg):
    print(f"Mensaje recibido: {msg.payload.decode()}") #Uso de metodo
# decode, ya que los datos vienen en binario usando "enconde()" o b""
...
#Función para guardar los datos en la base de datos, que luego se llama
# en la función on_message.
